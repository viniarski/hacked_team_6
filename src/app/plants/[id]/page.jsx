      ...
      <div className="max-w-7xl mx-auto">
        <header className="mb-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-800">{currentSpace.name} Plants</h1>
              <p className="text-gray-600 mt-1">Manage your plants in this space</p>
            </div>
            
            <div className="mt-4 md:mt-0">
              <button 
                className="flex items-center gap-2 px-4 py-2 bg-[#5c8f57] text-white rounded-lg hover:bg-[#4d7a49] transition-colors"
                onClick={() => {/* Add plant logic */}}
              >
